...
const API_URL = `${BASE_URL}/discover/tv?sort_by=popularity.desc&vote_average.gte=7&with_original_language=ko&${API_KEY}`;

const SEARCH_URL = `${BASE_URL}/search/tv?with_original_language=ko&${API_KEY}`;
